...
AS $$
DECLARE
  project_url TEXT := 'https://ezawikrlcdpyugqfopss.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImV6YXdpa3JsY2RweXVncWZvcHNzIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcwNTAwMjg2NywiZXhwIjoyMDIwNTc4ODY3fQ.9cbooaVsC1jaTXhFzukgMz3wXdLn9uQvtUizG3hvGBY'; -- full access needed for http request to storage
